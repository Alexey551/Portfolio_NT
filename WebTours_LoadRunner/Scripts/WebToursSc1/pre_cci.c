# 1 "c:\\loadtesting\\webtours\\scripts\\webtourssc1\\\\combined_WebToursSc1.c"
...
# 1 "c:\\loadtesting\\webtours\\scripts\\webtourssc1\\\\combined_WebToursSc1.c" 2
...
# 2 "c:\\loadtesting\\webtours\\scripts\\webtourssc1\\\\combined_WebToursSc1.c" 2
...
# 3 "c:\\loadtesting\\webtours\\scripts\\webtourssc1\\\\combined_WebToursSc1.c" 2
...
# 4 "c:\\loadtesting\\webtours\\scripts\\webtourssc1\\\\combined_WebToursSc1.c" 2
...
# 5 "c:\\loadtesting\\webtours\\scripts\\webtourssc1\\\\combined_WebToursSc1.c" 2
...
Action()
{
	...
	lr_end_transaction("05_CompletionBooking",2);
	...
	lr_end_transaction("06_GoToHomePage",2);
	...
	lr_end_transaction("07_ OpeningBookingList",2);
	...
	lr_end_transaction("08_ DeletingBooking",2);
	
	lr_message(lr_eval_string("    {CURRTIME} : Booking ({FLIGHTID}) is deleted"));
	return 0;
}
# 6 "c:\\loadtesting\\webtours\\scripts\\webtourssc1\\\\combined_WebToursSc1.c" 2
...
# 7 "c:\\loadtesting\\webtours\\scripts\\webtourssc1\\\\combined_WebToursSc1.c" 2
...
# 8 "c:\\loadtesting\\webtours\\scripts\\webtourssc1\\\\combined_WebToursSc1.c" 2
